      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-0">
        <div className="flex flex-col-reverse md:flex-row items-center justify-between gap-8 md:gap-12 lg:gap-16">
          ...
          <div className="w-full md:w-1/2 md:text-left">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-semibold tracking-tight text-gray-900 mb-4 sm:mb-5">
              We Create Your Home <br className="hidden sm:inline" /> More Aesthetic
            </h2>
            <p className="text-sm sm:text-base text-gray-700 mb-6 max-w-xl md:max-w-full">
            ...
            <div className="space-y-6 sm:space-y-7">
              <div className="flex items-start space-x-3 sm:space-x-4">
                ...
                <div>
                  <h3 className="text-lg sm:text-xl mb-2 font-semibold text-gray-900">Valuation Services</h3>
              ...
              <div className="flex items-start space-x-3 sm:space-x-4">
                ...
                <div>
                  <h3 className="text-lg sm:text-xl mb-2 font-semibold text-gray-900">Development of Furniture Models</h3>
                  <p className="mt-0.5 text-sm sm:text-base text-gray-600 max-w-xl md:max-w-full">
                    Sometimes features require a short description. This can be detailed description
                  </p>
                </div>
