  // components/sections/NewInStoreSection.jsx
  "use client";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row gap-8 md:gap-12 lg:gap-16 items-start">
            ...
            <div className="w-full md:w-1/3 lg:w-1/4 flex-shrink-0">
              ...
              <Link href="#" className="lg:flex items-center text-gray-900 hidden  font-semibold hover:text-gray-700 transition-colors duration-200">
                Check All
            ...
            {/* Right Cards Container with Horizontal Scroll */}
            <div
            ...
            >
              <div className="flex items-center space-x-6 pr-4">
                {newInItems.map((item) => (
                  <div key={item.id} className="flex-shrink-0 w-62 h-80 rounded-lg shadow-md overflow-hidden relative bg-white">
                    <Image
                      src={item.imageUrl}
                      alt={item.label}
                      fill
